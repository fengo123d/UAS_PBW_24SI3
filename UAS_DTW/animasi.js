...
function addToCart(productName, qtyId, price, grindGroupId) {
    ...
    // --- BAGIAN YANG DIUBAH ---
    // Menggunakan alert biasa agar hanya ada tombol "OK" atau pesan informasi
    alert("✔ Pesanan anda telah ditambahkan ke keranjang");

    // Reset angka counter ke 0 setelah berhasil
    ...
    // Update angka pada icon keranjang melayang (jika kamu pakai file floating_buttons.php)
